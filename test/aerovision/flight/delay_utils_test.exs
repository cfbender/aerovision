defmodule AeroVision.Flight.DelayUtilsTest do
  ...
  describe "delay_rgb/1" do
    test "nil returns gray" do
      assert DelayUtils.delay_rgb(nil) == [120, 120, 120]
    end

    test "0 minutes returns gray" do
      assert DelayUtils.delay_rgb(0) == [120, 120, 120]
    end

    test "19 minutes returns gray" do
      assert DelayUtils.delay_rgb(19) == [120, 120, 120]
    end

    test "20 minutes returns orange" do
      assert DelayUtils.delay_rgb(20) == [251, 146, 60]
    end

    test "45 minutes returns orange" do
      assert DelayUtils.delay_rgb(45) == [251, 146, 60]
    end

    test "60 minutes returns orange" do
      assert DelayUtils.delay_rgb(60) == [251, 146, 60]
    end

    test "61 minutes returns red" do
      assert DelayUtils.delay_rgb(61) == [248, 113, 113]
    end

    test "120 minutes returns red" do
      assert DelayUtils.delay_rgb(120) == [248, 113, 113]
    end
  end
  ...
  describe "delay_color/1" do
    test "nil returns gray class" do
      assert DelayUtils.delay_color(nil) == "text-gray-500"
    end

    test "0 minutes returns gray class" do
      assert DelayUtils.delay_color(0) == "text-gray-500"
    end

    test "19 minutes returns gray class" do
      assert DelayUtils.delay_color(19) == "text-gray-500"
    end

    test "20 minutes returns orange class" do
      assert DelayUtils.delay_color(20) == "text-orange-400"
    end

    test "60 minutes returns orange class" do
      assert DelayUtils.delay_color(60) == "text-orange-400"
    end

    test "61 minutes returns red class" do
      assert DelayUtils.delay_color(61) == "text-red-400"
    end

    test "120 minutes returns red class" do
      assert DelayUtils.delay_color(120) == "text-red-400"
    end
  end
end
